...
export const NotFound = () => {
    return (
        <div className="flex flex-1 items-center justify-center p-5 bg-white w-full">
            <div className="text-center">
                ...
                <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">Component Not Found</h1>
                <p className="text-slate-600 mt-5 lg:text-lg">The component you are looking for doesn't exist or <br />has been removed.</p>
            </div>
        </div>
    )
}
