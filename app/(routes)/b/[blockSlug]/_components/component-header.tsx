...
const ComponentHeader = ({ code, blockSlug, jsx }: PropsType) => {
  ...
  return (
    <header className=" bg-gray-100 h-14 border-b">
      <div className="bottom border-x-0 border-b-0  flex items-center justify-between border h-14 pl-6">
        ...
        <div className="flex items-center">
          ...
          <X onClick={() => router.push(`/b/${blockSlug}`)} className="h-14 border-x text-gray-400 cursor-pointer  hover:text-indigo-500 transition-all duration-300 w-14  p-4" />
